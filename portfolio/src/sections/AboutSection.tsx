...
import DecorShape from '../components/DecorShape';
...
export default function AboutSection() {
  return (
    ...
    >
      ...
      >
        <DecorShape name="sphere" className="h-auto w-full" />
      </FadeIn>
      ...
      >
        <DecorShape name="stack" className="h-auto w-full" />
      </FadeIn>
      ...
      >
        <DecorShape name="torus" className="h-auto w-full" />
      </FadeIn>
      ...
      >
        <DecorShape name="grid" className="h-auto w-full" />
      </FadeIn>
